...
st.title("Industrial Copper Modeling:sparkles:")
#menu
...
with open(r"C:\Users\Ezhil\OneDrive\Desktop\python pro\random_forest_regressor.pkl", 'rb') as file:
    loaded_reg_model = pickle.load(file)


with open(r"C:\Users\Ezhil\OneDrive\Desktop\python pro\item_type_label_encoder.pkl", 'rb') as f:
    type_loaded = pickle.load(f)

with open(r"C:\Users\Ezhil\OneDrive\Desktop\python pro\status_mapped.pkl", 'rb') as f:
    status_loaded = pickle.load(f)

with open(r"C:\Users\Ezhil\OneDrive\Desktop\python pro\random_forest_classifier.pkl", 'rb') as file1:
...
if selected=="HOME":
    ...
    with cola:
        st.image(r"C:\Users\Ezhil\OneDrive\Desktop\python pro\cp.png")
    with colb:
